...
public class DBService {
	...
	public void initialDB() {
		...
		Called called01 = new Called(null, Priority.MEDIUM, Status.PROGRESS, "Chamado 01", "Peimeiro chamado",
				technician01, client01);
		Called called02 = new Called(null, Priority.LOW, Status.PROGRESS, "Chamado 02", "Segundo chamado", technician01,
				client02);
		Called called03 = new Called(null, Priority.HIGH, Status.PROGRESS, "Chamado 03", "Terceiro chamado",
				technician02, client01);
		Called called04 = new Called(null, Priority.MEDIUM, Status.PROGRESS, "Chamado 04", "Quarto chamado",
				technician02, client02);
